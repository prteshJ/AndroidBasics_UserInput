...
public class MainActivity extends AppCompatActivity {
    ...
    public void increment(View view) {
        if (quantity == 100) {
            ...
            Toast.makeText(this, getString(R.string.too_many_coffee_orders, quantity), Toast.LENGTH_SHORT).show();
    ...
    public void decrement(View view) {
        if (quantity == 1) {
            // Show an error message as a toast
            Toast.makeText(this, getString(R.string.too_less_coffee_orders, quantity), Toast.LENGTH_SHORT).show();
            // Exit this method early because there's nothing left to do
            return;
        }
        quantity = quantity - 1;
    ...
    public String createOrderSummary(String name, int price, boolean addWhippedCream, boolean addChocolate) {
        ...
        priceMessage += "\n" + getString(R.string.order_summary_price, String.format(Locale.getDefault(), "$%d", price));
